...
public class PayCustom {
    ...
    public PayCustom(String apm, String npm, String activePay, String newPay, String apr, String npr, String appc, String nppc, String aARPU, String aARPPU, String nARPU, String nARPPU) {
        this.apm = apm;
        this.npm = npm;
