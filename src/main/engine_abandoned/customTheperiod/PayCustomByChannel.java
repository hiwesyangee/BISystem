 ...
 * 按渠道自定义周期充值对象
 */
public class PayCustomByChannel {
    ...
    public PayCustomByChannel(String channel, String apm, String npm, String activePay, String newPay, String apr, String npr, String appc, String nppc, String aARPU, String aARPPU, String nARPU, String nARPPU) {
