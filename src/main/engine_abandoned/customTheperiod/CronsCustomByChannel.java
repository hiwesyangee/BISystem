 ...
 * 按渠道自定义周期消费对象
 */
public class CronsCustomByChannel {
    ...
    public CronsCustomByChannel(String channel, String acm, String ncm, String activeCrons, String newCrons, String acr, String ncr, String apcc, String npcc) {
