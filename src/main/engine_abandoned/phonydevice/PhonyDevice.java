 ...
 * 获取phony设备相关数据
 */
public class PhonyDevice {
    private String times; // 具体天
    private String activateDevice; // 新增设备
    private String activeDevice; // 活跃设备
    private String topDeviceOnline; // 最高在线设备
    ...
    public PhonyDevice(String times, String activateDevice, String activeDevice, String topDeviceOnline, String totalLoginTimes, String averageOnlineTime, String liucun, String liucun2, String liucun3, String liucun4, String liucun5, String liucun6, String liucunWeek, String liucunWeek2, String liucunMonth) {
        this.times = times;
