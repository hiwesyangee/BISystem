...
public class MyUtils {
     ...
     * @return
     */
    public static boolean userIsActive(String uid) {
        String firstDay = JavaHBaseUtils.getValue(DataProcessProperties.USERFIRESTLOGINTABLE, uid, "info", "firstDay");
        if (firstDay == null) {
            return false;
        } else {
            String shifenmiao = JavaDateUtils.getDateYMD();
            String today = shifenmiao.substring(0, 8);
    ...
    public static void main(String[] args) {
        int pastdayNumber = 1;
        String lastDay = getLastDay("20181012", pastdayNumber);
        System.out.println(lastDay);
        String tomorrow = getLastDay("20181012", -pastdayNumber);
