...
public class UserByChannel {
    ...
    private String activateUser; // 新增设备
    private String activeUser; // 活跃设备
    private String topUserOnline; // 最高在线设备
    ...
    public UserByChannel(String times, String channel, String activateUser, String activeUser, String topUserOnline, String liucun, String liucun2, String liucun3, String liucun4, String liucun5, String liucun6, String liucunWeek, String liucunWeek2, String liucunMonth) {
        this.times = times;
